-- SQL script for manual setup in Supabase SQL editor
...
CREATE POLICY assessment_candidates_service_role_policy ON public.assessment_candidates FOR ALL TO service_role USING (true) WITH CHECK (true);
CREATE POLICY assessment_attempts_service_role_policy ON public.assessment_attempts FOR ALL TO service_role USING (true) WITH CHECK (true);
CREATE POLICY assessment_answers_service_role_policy ON public.assessment_answers FOR ALL TO service_role USING (true) WITH CHECK (true);
CREATE POLICY assessment_scores_service_role_policy ON public.assessment_scores FOR ALL TO service_role USING (true) WITH CHECK (true);
